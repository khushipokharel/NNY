...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showJournalPopup(journal, targetElement) {
        ...
        popup.style.left = `${rect.left + window.scrollX - popup.offsetWidth - 10}px`; // Positioned to the left
...
const journals = [
    ...
    { id: 3, title: "Does my dog know how to talk?", date: "23/9/2024", moodlevel: 4 },
    { id: 4, title: "Falling in love or is it just alcohol?", date: "24/9/2024", moodlevel: 6 },
    { id: 5, title: "Falling in love or is it just alcohol?", date: "25/9/2024", moodlevel: 9 },
  ];
